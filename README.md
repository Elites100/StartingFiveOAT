...
## 📍 The Process
I wanted to build something that combined basketball with interactive design. Instead of a static list of players, I decided to create a dynamic gallery that brings each legend to life. Starting with React, I built out the structure and gradually layered in animations using Framer Motion.
